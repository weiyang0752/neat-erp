package com.neaterp.module.infra.service.codegen.inner;
...
import com.neaterp.framework.apilog.core.enums.OperateTypeEnum;
...
import com.neaterp.framework.common.util.date.LocalDateTimeUtils;
import com.neaterp.framework.common.util.object.BeanUtils;
import com.neaterp.framework.common.util.object.ObjectUtils;
import com.neaterp.framework.common.util.string.StrUtils;
...
import com.neaterp.framework.mybatis.core.dataobject.BaseDO;
...
import com.neaterp.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.neaterp.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.neaterp.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.neaterp.module.infra.enums.codegen.CodegenSceneEnum;
import com.neaterp.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.neaterp.module.infra.enums.codegen.CodegenVOTypeEnum;
import com.neaterp.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/neaterp-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/neaterp-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "neaterp-module-${table.moduleName}/" + // 顶级模块
                "neaterp-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "neaterp-module-${table.moduleName}/" + // 顶级模块
                "neaterp-module-${table.moduleName}-server/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "neaterp-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "neaterp-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }

    private static String vue3VbenFilePath(String path) {
        return "neaterp-ui-${sceneEnum.basePackage}-vben/" + // 顶级目录
                "src/" + path;
    }
