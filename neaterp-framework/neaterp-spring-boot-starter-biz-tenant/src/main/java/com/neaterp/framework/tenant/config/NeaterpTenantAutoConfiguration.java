package com.neaterp.framework.tenant.config;

import com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor;
import com.baomidou.mybatisplus.extension.plugins.inner.TenantLineInnerInterceptor;
import com.neaterp.framework.common.biz.system.tenant.TenantCommonApi;
import com.neaterp.framework.common.enums.WebFilterOrderEnum;
import com.neaterp.framework.mybatis.core.util.MyBatisUtils;
import com.neaterp.framework.redis.config.NeaterpCacheProperties;
...
import com.neaterp.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.neaterp.framework.tenant.core.web.TenantContextWebFilter;
import com.neaterp.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.neaterp.framework.web.config.WebProperties;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "neaterp.tenant", value = "enable", matchIfMissing = true) // 允许使用 yudao.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class NeaterpTenantAutoConfiguration {
...
//    }
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     NeaterpCacheProperties neaterpCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(neaterpCacheProperties.getRedisScanBatchSize()));
